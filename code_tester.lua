...
local RarityConfig = {
    ["???"] = true, Divine = true, GOD = true, Admin = true, Event = false, Limited = true,
...
local RarityColors = {
    ["???"] = Color3.fromRGB(255, 0, 255), Divine = Color3.fromRGB(255, 215, 0),
    GOD = Color3.fromRGB(138, 43, 226), Admin = Color3.fromRGB(255, 0, 0),
    Event = Color3.fromRGB(0, 191, 255), Limited = Color3.fromRGB(255, 105, 180),
    OG = Color3.fromRGB(255, 140, 0), Exclusive = Color3.fromRGB(147, 112, 219),
    Exotic = Color3.fromRGB(0, 255, 127), secret = Color3.fromRGB(64, 64, 64),
    Mythic = Color3.fromRGB(255, 20, 147), Legendary = Color3.fromRGB(255, 165, 0),
    Epic = Color3.fromRGB(148, 0, 211), Rare = Color3.fromRGB(0, 112, 221),
    Uncommon = Color3.fromRGB(30, 255, 0), Common = Color3.fromRGB(155, 155, 155)
}
